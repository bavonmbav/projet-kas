...
import GraphiqueClient from './Client-graphique';
import Dashboard from './Dash-produit';
    ...
    const calculateTotals = (data) => {
        ...
        data.forEach(transaction => {
            ...
            if (transactionDate.toDateString() === new Date().toDateString()) {
                ...
                transaction.produits.map(produit => {
                    dailyTotalQuantite += parseInt(produit.quantity, 10);
                    console.log('la quantity', dailyTotalQuantite)
                });
    ...
    return (
        <Container>
            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Paper elevation={3} sx={{ padding: 2, backgroundColor: 'rgb(173 173 173)' }}>
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Paper elevation={3} sx={{ padding: 2, backgroundColor: 'rgb(5 255 162)' }}>
            ...
            <Typography variant="h6" gutterBottom style={{ marginTop: '20px' }}>statistique client standard</Typography>
            <GraphiqueClient />
            <Typography variant="h6" gutterBottom style={{ marginTop: '20px' }}>statistique produit</Typography>
            <Dashboard/>
        </Container>
    );
};
